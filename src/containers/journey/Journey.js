  ...
  return (
    <div className="main" id="journey">
      <div className="journey-header-div">
        ...
        <p
          className={
            isDark ? "dark-mode journey-subtitle" : "subTitle journey-subtitle"
          }
        >
          ...
          {journeyInfo.experiences.map((exp, index) => {
            return (
              <VerticalTimelineElement
                ...
                date={exp.duration}
                dateClassName={
                  isDark ? "timeline-date-dark" : "timeline-date-light"
                }
                contentStyle={{
                  background: isDark ? "rgba(255, 255, 255, 0.05)" : "#f4f4f4",
                  color: isDark ? "#fff" : "#000",
                  boxShadow: isDark
                    ? "0px 10px 30px -15px rgba(255, 255, 255, 0.15)"
                    : "0px 10px 30px -15px rgba(0, 0, 0, 0.2)",
                  borderRadius: "16px",
              ...
              >
                ...
                <h4
                  ...
                  style={{fontSize: "1.1rem", marginTop: "5px", opacity: 0.8}}
                >
                  <a
                ...
                <p style={{fontWeight: 400, opacity: 0.9}}>{exp.description}</p>
              </VerticalTimelineElement>
            );
          })}
        </VerticalTimeline>
